...
* (three 4-point vertices, middle one is O(p^4))
*
*    \1       |5       /8   
*     \       |       /
*      \      |      /    
...
#call vertex(4,4,`PARAM',VC`PARAM')
...
#call connect(l,1,1,VR`PARAM',VLC`PARAM',M8p4e`PARAM')
...
print +s;
.store
save save/M8p4e`PARAM'.sav M8p4e`PARAM';
